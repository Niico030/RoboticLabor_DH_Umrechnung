...
%% generated by the gui
    % Properties that correspond to app components - generate automatically
    properties (Access = public)
        ...
        MoveITTab                      matlab.ui.container.Tab
...
%% HERE IS OUR OWN CODE
    % private properties using in our own coding
    ...
    methods (Access = private)
        ...
        function CalculateDenavitHartenbergButtonPushed(app, event)
            ...
            if app.index == 0
                ...
                [app.tethaList, app.dList, app.aList, app.alphaList] = calculateDenavitHartenbergParam(app.BasisVektorsList, app.QuaternionZeroList, app.QuaternionVektorList);
                app.OutputData = [app.tethaList, app.dList, app.aList, app.alphaList];
                app.DenavitTable.Data = app.OutputData; 
                ddvalue = app.DropDown.Items;
                for i = 1:app.index
                    ddvalue{i+1} = convertStringsToChars('L' +string(i));
                end
            end
            app.DropDown.Items = ddvalue;
        ...
        function ShowPlotButtonPushed(app, event)
            if app.index < 2
                ...
                if isempty(app.OutputData)
                    ...
                    app.moving = zeros(1, app.index);
                    showRobotInPlot(app.tethaList, app.dList, app.aList, app.alphaList, app.moving);
                end
            end
        ...
        % Button down function: MoveITTab
        function MoveITTabButtonDown(app, event)
            hold on
        end
    end
...
%% generated by the gui
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.DenavitTable.ColumnName = {'tetha'; 'd'; 'a'; 'alpha'};
            ...
            % Create MoveITTab
            app.MoveITTab = uitab(app.TabGroup);
            app.MoveITTab.Title = 'Move IT';
            app.MoveITTab.ButtonDownFcn = createCallbackFcn(app, @MoveITTabButtonDown, true);

            % Create SliderLabel
            app.SliderLabel = uilabel(app.MoveITTab);
            app.SliderLabel.HorizontalAlignment = 'right';
            app.SliderLabel.Position = [260 131 36 22];
            app.SliderLabel.Text = 'Slider';

            % Create Slider
            app.Slider = uislider(app.MoveITTab);
            app.Slider.Limits = [-3.14159265358979 3.14159265358979];
            app.Slider.ValueChangedFcn = createCallbackFcn(app, @SliderValueChanged, true);
            app.Slider.ValueChangingFcn = createCallbackFcn(app, @SliderValueChanging, true);
            app.Slider.Position = [317 140 150 3];

            % Create DropDownLabel
            app.DropDownLabel = uilabel(app.MoveITTab);
            app.DropDownLabel.HorizontalAlignment = 'right';
            app.DropDownLabel.Position = [45 119 66 22];
            app.DropDownLabel.Text = 'Drop Down';

            % Create DropDown
            app.DropDown = uidropdown(app.MoveITTab);
            app.DropDown.Items = {'none'};
            app.DropDown.Position = [126 119 100 22];
